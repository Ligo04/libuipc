...
Args:
    ...
    class_Attribute.def("clear", &Attributes::clear, R"(Clear all attributes.)");
...
PySimplicialComplex::PySimplicialComplex(py::module_& m)
{
    ...
    auto class_VertexAttributes = py::class_<SimplicialComplex::VertexAttributes>(
        class_SimplicialComplex, "VertexAttributes", R"(Vertex attributes for the simplicial complex.)");

    auto class_EdgeAttributes = py::class_<SimplicialComplex::EdgeAttributes>(
        class_SimplicialComplex, "EdgeAttributes", R"(Edge attributes for the simplicial complex.)");

    auto class_TriangleAttributes = py::class_<SimplicialComplex::TriangleAttributes>(
        class_SimplicialComplex, "TriangleAttributes", R"(Triangle attributes for the simplicial complex.)");

    auto class_TetrahedronAttributes = py::class_<SimplicialComplex::TetrahedronAttributes>(
        class_SimplicialComplex,
...
Returns:
    ...
    class_SimplicialComplex.def(
        "copy",
        [](SimplicialComplex& self) -> SimplicialComplex { return self; },
        R"(Create a copy of the simplicial complex.
Returns:
    SimplicialComplex: Copy of the simplicial complex.)");

    class_SimplicialComplex.def("dim",
                                &SimplicialComplex::dim,
...
Returns:
    ...
    class_SimplicialComplex.def(
        "__repr__",
        [](const SimplicialComplex& self) { return fmt::format("{}", self); },
