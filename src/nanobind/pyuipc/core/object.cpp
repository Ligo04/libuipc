...
Returns:
    ...
    auto class_Geometries = py::class_<Object::Geometries>(
        class_Object, "Geometries", R"(Collection of geometries belonging to an object.)");

    class_Object.def(
        "name",
        [](Object& self) { return self.name(); },
...
Returns:
    ...
    class_Geometries.def(
        ...
        {
            auto [new_geo, new_rest_geo] = std::move(self).create(geo, rest_geo);
