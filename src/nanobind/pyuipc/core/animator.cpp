...
PyAnimator::PyAnimator(py::module_& m)
{
    ...
    auto class_UpdateHint = py::class_<Animation::UpdateHint>(
        class_Animation, "UpdateHint", R"(Update hint enumeration for animation updates.)");

    auto class_UpdateInfo = py::class_<Animation::UpdateInfo>(
        class_Animation, "UpdateInfo", R"(Update information passed to animation callbacks.)");
...
Args:
    ...
    class_Animator.def(
        "substep",
        [](Animator& self, SizeT substep) { self.substep(substep); },
        py::arg("substep"),
...
Args:
    ...
    class_Animator.def(
        "substep",
        [](Animator& self) { return self.substep(); },
        R"(Get the substep count.
Returns:
    int: Number of substeps per frame.)");

    class_Animator.def("animation_count",
...
Returns:
    ...
    class_Animator.def("has_animation",
...
Returns:
    ...
    class_Animator.def("animation_ids",
