...
{
    auto class_Span =
        py::class_<span<T>>(h, name, R"(Span class for viewing contiguous sequences of data.)");
    class_Span.def("__len__",
                   &span<T>::size,
